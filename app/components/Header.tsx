...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-[#00674F]">
      {/* Desktop Header */}
      <div className="hidden lg:block relative w-full max-w-[1440px] mx-auto h-[129px]">
        {/* Logo Group */}
        ...
        <nav className="absolute w-[773px] h-[72px] left-[calc(50%-773px/2+316.5px)] top-6 flex flex-col justify-center items-center bg-[#4C4C4C]/50 shadow-md rounded-full py-4 pl-4">
          <div className="flex flex-row justify-center items-center gap-5">
            ...
            <Link
              href="#launch"
              className="flex flex-col justify-center items-center w-[151px] h-[45px] bg-white backdrop-blur-sm rounded-[65px] px-7 py-3 hover:opacity-90 transition-opacity"
            >
      ...
      <div className="lg:hidden flex items-center justify-between px-4 md:px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="#launch"
            className="hidden sm:flex flex-col justify-center items-center h-10 bg-white backdrop-blur-sm rounded-[65px] px-5 py-2.5 hover:opacity-90 transition-opacity"
          >
